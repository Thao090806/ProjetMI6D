...
void effet_cible(Personnage *attaquant, Personnage *cible, int index_competence) {
    ...
    if (index_competence < 0 || index_competence >= MAX_COMPETENCES) {
        printf("\033[1;31mIndex de competence invalide.\033[0m\n");
        return;
    }
...
void trier_vitesse(Personnage personnages[], int taille) {
    if (personnages == NULL || taille <= 0) {
        printf("\033[1;31mErreur : tableau de personnages ou taille invalide.\033[0m\n");
        return;
    }
...
void tour_equipe(Equipe *equipe, Personnage *attaquant, Personnage equipe_ennemie[], int nb_ennemis) {
    if (equipe == NULL || attaquant == NULL || equipe_ennemie == NULL || nb_ennemis <= 0) {
        printf("\033[1;31mErreur : equipe, attaquant ou equipe ennemie invalide.\033[0m\n");
        return;
    }
    if (equipe->nom == NULL){
...
void joueur_vs_univers(Equipe *equipe_joueur, Personnage *equipe_j, int nb_joueurs, Personnage *equipe_ennemie, int nb_ennemis) {
    if (equipe_joueur == NULL || equipe_j == NULL || equipe_ennemie == NULL) {
        printf("\033[1;31mErreur : equipe joueur ou equipe ennemie invalide.\033[0m\n");
        return;
    }
    if (nb_joueurs <= 0 || nb_ennemis <= 0) {
        printf("\033[1;31mErreur : le nombre de joueurs ou d'ennemis doit etre superieur a 0.\033[0m\n");
        return;
    }
...
void joueur_vs_joueur(Equipe *equipe1, Personnage *equipe_j1, int nb_joueurs1,Equipe *equipe2, Personnage *equipe_j2, int nb_joueurs2) {
    if (equipe1 == NULL || equipe_j1 == NULL || equipe2 == NULL || equipe_j2 == NULL) {
        printf("\033[1;31mErreur : equipe 1 ou 2 ou personnages invalides.\033[0m\n");
        return;
    }
    if (nb_joueurs1 <= 0 || nb_joueurs2 <= 0) {
        printf("\033[1;31mErreur : le nombre de joueurs doit etre superieur a 0.\033[0m\n");
        return;
    }
    Personnage tous_combattants[MAX_MEMBRES * 2];
